...
export default {
  ...
  data() {
    return {
      ...
      cvLink: process.env.BASE_URL + 'files/Hariawan-Nur-Fajri.pdf', // CV link
    };
  },
  mounted() {
    feather.replace();
...
<template>
  <section class="flex flex-col sm:justify-between items-center sm:flex-row mt-12 sm:mt-10">
    ...
    <div class="w-full md:w-1/3 text-left">
      <h1
        class="font-general-semibold text-2xl md:text-2xl xl:text-4xl text-center sm:text-left text-ternary-dark dark:text-primary-light uppercase"
      >
        Hi, I am Hariawan
      </h1>
      <p
      ...
      <div class="flex justify-center sm:block">
        <a
          download="Hariawan-Nur-Fajri.pdf"
          :href="cvLink"
